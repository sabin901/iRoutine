...
export function FocusHeatmap() {
  ...
  const { heatmapData, maxValue, stats, filteredData } = useMemo(() => {
    ...
    if (intensityFilter === 'high') {
      filteredData = displayData.map(d => ({
        ...d,
    ...
    return (
      <div className="rounded-2xl border border-neutral-200/60 bg-white p-6 shadow-soft-lg">
        <div className="text-center py-12">
          ...
          <p className="text-sm text-neutral-500 font-medium">No focus activities logged yet</p>
        </div>
      </div>
    )
  }
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-neutral-900">Focus Time Heatmap</h2>
              <p className="text-xs text-neutral-500">7-day focus analysis</p>
            </div>
          </div>
